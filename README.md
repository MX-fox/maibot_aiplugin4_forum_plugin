...
| `forum_create_post` | 创建新帖子（支持图片上传） | ✅ |
...
### v1.1.0
- 添加 `ForumCommand` 快捷命令组件
- 重构代码，抽取 `ForumBaseTool` 基类
- 添加 HTTP 请求超时控制（30秒）
- 添加完整的日志记录
- 添加输入验证（标题长度、内容长度）
- 抽取 API 路径为常量
